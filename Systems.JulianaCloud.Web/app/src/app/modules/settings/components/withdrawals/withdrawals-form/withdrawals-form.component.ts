...
@Component({
    selector: 'withdrawals-form',
    templateUrl: './withdrawals-form.component.html',
    styleUrls: ['./withdrawals-form.component.scss']
  })
  export class WithdrawalsFormComponent implements AfterViewInit {
    ...
    initData(isNew: boolean = false) {
      this.models$ = this.withdrawalService.getAll();
  ...
  saveChanges() {
      ...
      this.withdrawalService[this.isNew ? 'create' : 'update'](this.model)
            .subscribe(
                response => {
