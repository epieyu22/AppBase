...
import { ProfessionService } from '@modules/generals/services/profession.service';
import { ProfessionsFormComponent } from '@modules/generals/components/professions/professions-form/professions-form.component';
...
export class ProfessionManagerComponent {
  self: any;
  popupVisible = false;
  currentModel: any
  data: any;
  ...
  collapsed = false;
  professionStore: CustomStore;
  gridContext: any;
  translations: any = {};
  @ViewChild("grid") dataGrid: DxDataGridComponent
  @ViewChild("form") form: ProfessionsFormComponent
  ...
  constructor(
    ...
    private spinner: NgxSpinnerService
      ...
      this.professionStore = professionService.getStore();
      this.currentModel = {};
      this.self = this;
  ...
  getCrudConfig() {
    return {
      onEdit: (data: any) => this.professionService.update(data),
      onDelete: (data: any) => this.professionService.delete(data.code)
    }
  }
  ...
  deleteEntry(e) {
    let result = confirm(
      this.translations['GENERALS.PROFESSIONS.CONFIRM_DELETE_MESSAGE']
  ...
  loadTranslations(){
    ...
    this.translateService.get([
      'GENERALS.PROFESSIONS.CONFIRM_DELETE_MESSAGE',
