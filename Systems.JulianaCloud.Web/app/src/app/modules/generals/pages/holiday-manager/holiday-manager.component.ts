...
import { HolidayService } from '@modules/generals/services/holiday.service';
import { HolidaysFormComponent } from '@modules/generals/components/holidays/holidays-form/holidays-form.component';
...
export class HolidayManagerComponent {
  ...
  collapsed = false;
  holidayStore: CustomStore;
  gridContext: any;
  translations: any = {};
  @ViewChild("grid") dataGrid: DxDataGridComponent
  @ViewChild("form") form: HolidaysFormComponent
  ...
  constructor(
    ...
    private spinner: NgxSpinnerService
      ...
      this.holidayStore = holidayService.getStore();
      this.currentModel = {};
      this.self = this;
  ...
  getCrudConfig() {
    return {
      onEdit: (data: any) => this.holidayService.update(data),
      onDelete: (data: any) => this.holidayService.delete(data.code)
    }
  }
  ...
  deleteEntry(e) {
    let result = confirm(
      this.translations['GENERALS.HOLIDAYS.CONFIRM_DELETE_MESSAGE']
  ...
  loadTranslations(){
    ...
    this.translateService.get([
      'GENERALS.HOLIDAYS.CONFIRM_DELETE_MESSAGE',
