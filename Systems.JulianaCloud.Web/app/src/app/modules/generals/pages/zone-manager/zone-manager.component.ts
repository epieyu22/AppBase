...
import { ZonesFormComponent } from '@modules/generals/components/zones/zones-form/zones-form.component';
...
export class ZoneManagerComponent {
  ...
  @ViewChild("form") form: ZonesFormComponent
  ...
  constructor(
    ...
    private spinner: NgxSpinnerService
      ...
      this.zoneStore = zoneService.getStore();
      this.currentModel = {};
      this.self = this;
  ...
  getCrudConfig() {
    return {
      onEdit: (data: any) => this.zoneService.update(data),
      onDelete: (data: any) => this.zoneService.delete(data.code)
    }
  }
  ...
  deleteEntry(e) {
    let result = confirm(
      this.translations['GENERALS.ZONES.CONFIRM_DELETE_MESSAGE']
  ...
  loadTranslations(){
    ...
    this.translateService.get([
      'GENERALS.ZONES.CONFIRM_DELETE_MESSAGE',
