...
import { DepartmentsFormComponent } from '@modules/generals/components/departments/departments-form.component';
...
export class DepartmentManagerComponent {
  ...
  collapsed = false;
  departmentStore: CustomStore;
  gridContext: any;
  translations: any = {};
  @ViewChild("grid") dataGrid: DxDataGridComponent
  @ViewChild("form") form: DepartmentsFormComponent
  ...
  constructor(
    ...
    private spinner: NgxSpinnerService
      ...
      this.departmentStore = departmentService.getStore();
      this.currentModel = {};
      this.self = this;
  ...
  getCrudConfig() {
    return {
      onEdit: (data: any) => this.departmentService.update(data),
      onDelete: (data: any) => this.departmentService.delete(data.code)
    }
  }
  ...
  deleteEntry(e) {
    let result = confirm(
      this.translations['GENERALS.DEPARTMENTS.CONFIRM_DELETE_MESSAGE']
  ...
  loadTranslations(){
    ...
    this.translateService.get([
      'GENERALS.DEPARTMENTS.CONFIRM_DELETE_MESSAGE',
